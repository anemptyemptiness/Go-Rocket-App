...
func (_mock *InventoryClient) ValidateCompatibility(ctx context.Context, parts []model.Part) error {
...
//   - ctx context.Context
//   - parts []model.Part
func (_e *InventoryClient_Expecter) ValidateCompatibility(ctx interface{}, parts interface{}) *InventoryClient_ValidateCompatibility_Call {
	return &InventoryClient_ValidateCompatibility_Call{Call: _e.mock.On("ValidateCompatibility", ctx, parts)}
}

func (_c *InventoryClient_ValidateCompatibility_Call) Run(run func(ctx context.Context, parts []model.Part)) *InventoryClient_ValidateCompatibility_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *InventoryClient_ValidateCompatibility_Call) RunAndReturn(run func(ctx context.Context, parts []model.Part) error) *InventoryClient_ValidateCompatibility_Call {
	_c.Call.Return(run)
	return _c
}
