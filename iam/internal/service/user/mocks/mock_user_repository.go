...
func (_mock *UserRepository) Create(ctx context.Context, login string, password string) (uuid.UUID, error) {
...
func (_c *UserRepository_Create_Call) Return(uUID uuid.UUID, err error) *UserRepository_Create_Call {
	_c.Call.Return(uUID, err)
	return _c
}

func (_c *UserRepository_Create_Call) RunAndReturn(run func(ctx context.Context, login string, password string) (uuid.UUID, error)) *UserRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
