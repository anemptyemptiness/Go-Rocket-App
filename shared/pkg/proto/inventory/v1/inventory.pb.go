...
// Запрос на получение списка деталей с возможность фильтрации по типу или конкретным UUID
...
// Ответ на запрос получения списка деталей с возможность фильтрации по типу или конкретным UUID
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBUZSgithub.com/anemptyemptiness/Go-Rocket-App/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
